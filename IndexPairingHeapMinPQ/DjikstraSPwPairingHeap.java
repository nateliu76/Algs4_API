 ...
 *  @author Kevin Wayne
 */
public class DijkstraSPwPairingHeap {
    private double[] distTo;          // distTo[v] = distance  of shortest s->v path
    private DirectedEdge[] edgeTo;    // edgeTo[v] = last edge on shortest s->v path
    private IndexPairingHeapMinPQ<Double> pq;    // priority queue of vertices
     ...
     */
    public DijkstraSPwPairingHeap(EdgeWeightedDigraph G, int s) {
        ...
        pq = new IndexPairingHeapMinPQ<Double>(G.V());
    ...
    public static void main(String[] args) {
        ...
        DijkstraSPwPairingHeap sp = new DijkstraSPwPairingHeap(G, s);
